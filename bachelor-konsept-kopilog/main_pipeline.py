...
log_op(f"Starter hovedpipen for alle filer samtidig...", type="INFO")
...
if not input_files:
    ...
    log_op(f"Ingen tekstfiler funnet i input-mappen.", type="WARNING")
...
log_op(f"Initialiserer modul 1", type="INFO")
...
log_op(f"Initialiserer modul 2", type="INFO")
...
log_op(f"Initialiserer modul 3", type="INFO")
...
log_op(f"Initialiserer modul 4", type="INFO")
...
log_op(f"Hovedpipeline fullført! Sjekk output-mappen.", type="INFO")